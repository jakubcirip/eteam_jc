...
class API {
  ...
  getPublicImg(
    ...
    let path = '/public/fm/png/{imgId}/{intTag}';
    let headers: Headers = new Headers();
    let queryParameters: QueryParameters = {};
    ...
    path = path.replace('{imgId}', imgId.toString());
   ...
   * @name API#getImgSrc
   */
  getImgSrc(imgId: string, parameters: {} = {}): Promise<{}> {
    let path = '/hr/fm/png/{imgId}';
    let headers: Headers = new Headers();
    let queryParameters: QueryParameters = {};
  ...
  /**
   * Check if HR can edit Image file
   * @method
   * @name API#hrCanEditImg
   */
  hrCanEditImg(
    imgId: string,
    parameters: {} = {},
    ...
    let path = '/hr/fm/png/{imgId}/canedit';
    let headers: Headers = new Headers();
    let queryParameters: QueryParameters = {};
